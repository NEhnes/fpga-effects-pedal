 ...
 *
 * Architecture:
 * - Pre-Gain -> Asymmetric Clip -> Tone LPF -> Makeup Gain
 *   -> Output
 *
 *==============================================================
 ...
 *==============================================================
 * TODO
 * - auto-calculate makeup gain based on input params
 *=============================================================*/
...
module fuzz #(
    ...
    input  wire [15:0] pre_gain,         // Q2.13 signed
    ...
    //==========================================================
    // Stage 3: Makeup gain (signed Q1.14 multiplication)
    //==========================================================
