...
python3 ~/fpga-effects-pedal/testing/scripts/hex24_to_wav.py \
  ../data/hex/hm_2w-output.hex ../data/wav/hm-2w.wav --rate 48000

# DISPLAY WAVEFORM
python3 ../wave-tui/term_wave.py ../data/hex/hm_2w-output.hex ../data/input.hex
